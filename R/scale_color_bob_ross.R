...
#' @export
#'
#' @examples scale_color_bob_ross(painting = "peaceful_valley", type = "qualitative")


scale_color_bob_ross <- function(painting = c("peaceful_valley", "a_walk_in_the_woods"),
  ...
  return(ggplot2::scale_color_manual(values = I(scale_colors$hex)))
